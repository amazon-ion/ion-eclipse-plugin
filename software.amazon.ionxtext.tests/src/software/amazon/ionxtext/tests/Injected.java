    ...
    extends Suite
{
        ...
        extends BlockJUnit4ClassRunner
    {
        ...
        {
            // Eclipse (Neon) can't display results properly if the names
            // are not unique.
        ...
        throws Throwable
    {
        ...
        for (FrameworkField field : fields)
        {
            ...
            dim.values = dimensionValues(testClass, field);
            dimensions[i++] = dim;
        }
    ...
    private static Object[] dimensionValues(TestClass testClass,
                                            FrameworkField field)
        throws Exception
    {
        try
        ...
        {
            throw new Exception("@Inject failed to get the value of "
                                    + testClass.getName() + '.'
                                    + field.getField().getName(),
                                e);
        }
